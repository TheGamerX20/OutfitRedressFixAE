# Outfit Redress Fix AE

Outfit Redress Fix updated for the Next-Gen and Anniversary Editions.<br>
...
## Getting Started
```bat
git clone --recurse-submodules https://github.com/TheGamerX20/OutfitRedressFixAE
cd OutfitRedressFixAE
```
